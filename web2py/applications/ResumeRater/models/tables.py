...
db.define_table('reply',
                Field('post_id', 'reference post'),  # The replied post
                Field('reply_author', defualt=get_user_email()),  # The user who made the reply
                Field('reply_content', 'text'),  # The reply's content
